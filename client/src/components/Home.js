      ...
      <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
        <div className="flex h-full items-center justify-center">
          <div className="text-white">
            <h2 className="mb-4 text-4xl font-semibold">Welcome To Vendor Management App</h2>
            <h4 className="mb-6 mx-50 text-xl font-semibold">Vendor management plays a key role when it comes to selecting the right vendor for a particular business need.</h4>
            <button
              type="button"
